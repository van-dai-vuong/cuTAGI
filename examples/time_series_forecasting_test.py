...
def main(num_epochs: int = 20, batch_size: int = 1, sigma_v: float = 2):
    ...
    for epoch in pbar:
        ...
        for x, y in batch_iter:
            ...
            # print(f"mean   :{ net.input_delta_z_buffer.delta_mu}")
            # print(f"var: : {net.input_delta_z_buffer.delta_var}")
            # Feed backward
            net.backward()
            net.step()
